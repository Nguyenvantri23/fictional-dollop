...
local Window = Fluent:CreateWindow({
    Title = "Trí Đẹp Zai Hub| Blox Fruits",
    SubTitle = "by Văn Trí",
    TabWidth = 160,
...
DiscordLib:Notification("Thông Báo" , "Trí đẹp zai hub loading thành công"
local Tabs = {
...
ImageButton.Image = "http://www.roblox.com/asset/?id=17777184830"
